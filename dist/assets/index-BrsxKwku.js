 ...
 * @version 0.0.7
 * @license MIT
 */(async function(t){let e;t.style.imageRendering="pixelated",t.style.imageRendering="crisp-edges";try{e=new(await a.RenderPipeline(t,"Multisampling"))}catch(r){alert(r)}const i=e.CreateMultisampleState(),c=e.CreateShaderModule(p);e.CreatePipeline({module:c,multisample:i});const o=e.CreateColorAttachment();o.clearValue=new d(5000268).rgba,e.CreatePassDescriptor(o);const n=new(await a.LegacyTexture());n.LegacyRenderer=e,new ResizeObserver(r=>{for(const l of r){const{inlineSize:s,blockSize:u}=l.contentBoxSize[0];e.SetCanvasSize(s/16|0,u/16|0,!1)}e.MultisampleTexture=n.CreateMultisampleTexture(),e.Render(3)}).observe(document.body)})(document.getElementById("lesson"));
