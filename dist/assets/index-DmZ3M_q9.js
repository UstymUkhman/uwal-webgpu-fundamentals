 ...
 * @version 0.0.7
 * @license MIT
 */(async function(o){let e;try{e=new(await d.RenderPipeline(o,"Shader Constants"))}catch(r){alert(r)}const t=e.CreateShaderModule(f),a=e.CreateVertexState(t),i=e.CreateFragmentState(t,void 0,void 0,{RED:1,123:.5});e.CreatePipeline({vertex:a,fragment:i});const n=e.CreateColorAttachment();n.clearValue=new l(5000268).rgba,e.CreatePassDescriptor(n),new ResizeObserver(r=>{for(const c of r){const{inlineSize:s,blockSize:v}=c.contentBoxSize[0];e.SetCanvasSize(s,v)}e.Render(3)}).observe(document.body)})(document.getElementById("lesson"));
