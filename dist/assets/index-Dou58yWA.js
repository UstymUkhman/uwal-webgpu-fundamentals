import{c as y}from"./F-CZA4EI5f.js";import{v as S,a as C}from"./uwal-C6J7qtYI.js";import{m as o}from"./wgpu-matrix.module-3qzuEYdi.js";var h="struct Uniforms{color: vec4f,matrix: mat3x3f};@group(0)@binding(0)var<uniform>uniforms: Uniforms;@vertex fn vertex(@location(0)position: vec2f)->@builtin(position)vec4f {let clipSpace=(uniforms.matrix*vec3f(position,1)).xy;return vec4f(clipSpace,0.0,1.0);}@fragment fn fragment()->@location(0)vec4f {return uniforms.color;}";/**
